...
eventstore_url =
  System.get_env("EVENTSTORE_URL") ||
    ...
    For example: ecto://USER:PASS@HOST/EVENTSTORE
    """

config :mam_wirusa, MamWirusa.EventStore,
  # ssl: true,
  url: eventstore_url,
  pool_size: String.to_integer(System.get_env("ES_POOL_SIZE") || "10")
...
#
#     config :mam_wirusa, MamWirusaWeb.Endpoint, server: true
#

defmodule MamWirusaWeb.CaseControllerTest do
  use MamWirusaWeb.ConnCase

  alias MamWirusa.Spread

  @create_attrs %{infected_at: "2010-04-17T14:00:00Z", information: "some information"}
  ...
  def fixture(:case) do
    {:ok, case} = Spread.create_case(@create_attrs)
    case
  end
